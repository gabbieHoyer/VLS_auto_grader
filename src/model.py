...
# src/model.py (or wherever you have get_model)
...
def get_model(
    ...
    Args:
        ...
        patch_size (int): patch side length (only used when pretrain_method=='mae').
        mask_ratio (float): fraction of patches to mask (only for MAE).
