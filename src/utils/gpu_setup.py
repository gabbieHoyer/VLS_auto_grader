...
# ---------------------------------
# worked great except for that annoying init warning on single gpu:
...
#         # Store rank, world_size, and local_rank as class attributes for access
#         GPUSetup._rank = rank
#         GPUSetup._world_size = world_size
#         GPUSetup._local_rank = local_rank
...
# Note: setup_logging is more related to logger.py, so it should be moved there
# For now, we'll leave it out of GPUSetup and address it in a separate update to logger.py
